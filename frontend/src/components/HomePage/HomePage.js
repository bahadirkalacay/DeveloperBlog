...
const HomePage = () => {
  return (
    <>
      <section className="h-screen-full bg-white font-Industry">
        <div className="relative container px-4 mt-4  mx-auto">
          <div className="flex flex-wrap items-center -mx-4 mb-10 2xl:mb-14">
            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              ...
              <a
                className="inline-block mt-4 px-8 py-4 text-lg text-white font-bold bg-black  rounded-full transition duration-200"
                href="/create-post"
              >
                Create a Post
              </a>
