      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-wrap items-center -mx-4">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="px-6 lg:px-20 py-12 lg:py-24 bg-gray-700 rounded-lg">
              <form onSubmit={formik.handleSubmit}>
                ...
                {loading ? (
                  ...
                  <button
                    type="submit"
                    className="py-4 w-full bg-green-500 hover:bg-green-600 text-white font-bold rounded-full transition duration-200"
                  >
                    Register
                  </button>
                )}
