...
const Login = () => {
  ...
  return (
    <>
      <section className="min-h-screen relative py-12 2xl:py-20 bg-black overflow-hidden">
        ...
        <div className="relative container px-4 mx-auto">
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-wrap items-center -mx-4">
                ...
                <div className="px-6 lg:px-12 py-12 lg:py-24 bg-white shadow-lg rounded-lg">
                  <form onSubmit={formik.handleSubmit}>
                    ...
                    {loading ? (
                      ...
                      <button
                        type="submit"
                        className="py-4 w-full bg-black  text-white font-bold rounded-full transition duration-200"
                      >
                        Login
                      </button>
                    )}
              ...
              <div className="w-full lg:w-3/5 px-4 lg:mb-0 order-first lg:order-last" >
                <span className="flex  mx-auto items-center justify-center h-20 w-20 bg-green-500 rounded-lg">
                  <svg
                    width="37"
                    height="37"
                    viewBox="0 0 37 37"
                ...
                <h2 className=" text-center text-6xl lg:text-7xl text-white font-bold font-heading">
