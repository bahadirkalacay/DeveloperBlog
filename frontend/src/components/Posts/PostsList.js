...
export default function PostsList() {
  ...
  return (
    <>
      <section>
        <div className="py-2 bg-white min-h-screen radius-for-skewed ">
          <div className="container mx-auto px-4">
            <div className="mb-16 flex flex-wrap items-center">
              <div className="w-full lg:w-5/6">
                ...
                <h2 className="text-4xl text-yellow-500 lg:text-5xl font-bold font-heading">
                  Latest Post
                </h2>
              </div>
              <div>
              <button
                ...
                className="flex py-2 px-6 rounded-l-xl rounded-t-xl bg-green-600 hover:bg-green-700 text-gray-50 font-bold leading-loose transition duration-200 mt-2"
              >
                View All Posts
              </button>
              </div>
            ...
            <div className="flex flex-wrap -mx-3">
              <div className="mb-8 lg:mb-0 w-full lg:w-1/4 px-3">
                <div className="py-4 px-6 bg-gray-900 shadow rounded">
                  <h4 className="mb-4 text-gray-400 font-bold uppercase">
                    Categories
                  </h4>
                  <ul key={post}>
                    {catLoading ? (
                    ...
                    >
                      ...
                      <div className="w-full lg:w-3/4 px-3 ">
                        <Link className="hover:underline">
                          <h3 className="mb-1 mt-2 text-2xl text-green-400 font-bold font-heading">
