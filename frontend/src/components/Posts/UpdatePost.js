...
export default function UpdatePost(props) {
  ...
  return (
    <>
      <div className="font-Industry bg-white flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <h2 className="text-center text-3xl font-extrabold text-gray-500">
            Are you sure you want to edit {""}
            <span className="text-green-500">{postDetails?.title}</span>
          </h2>
          {appErr || serverErr ? (
            ...
            <form onSubmit={formik.handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="rounded-lg text-left appearance-none block w-full py-3 px-3 text-base leading-tight text-gray-600 bg-transparent focus:bg-transparent  border border-gray-200 focus:border-gray-500  focus:outline-none"
                  type="text"
                ></textarea>
                <div className="text-red-500">
